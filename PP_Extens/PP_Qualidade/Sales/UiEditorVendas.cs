...
namespace PP_Qualidade.Sales
{
    public class UiEditorVendas : EditorVendas
    {
        ...
        public override void ArtigoIdentificado(string Artigo, int NumLinha, ref bool Cancel, ExtensibilityEventArgs e)
        {
            ...
            using (
                DataTable fornecedorTbl = _Helpers.GetDataTableDeSQL(
            ...
            {
                string lote = _Helpers.MostraInputForm("Lote", "Introduza o lote do artigo:", art.CamposUtil["CDU_UltimoLote"].Valor.ToString().Trim());
